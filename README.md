...
17. [Introduction to Data Structures](#introduction-to-data-structures)
    - What is Data Structure: Types, Classifications, and Applications
    - Introduction to Data Structures
    - Common operations on various Data Structures
18. [Popular types of Data Structures](#popular-types-of-data-structures)
    - Array
    - Linked List
    - Stack
    - Queue
...
24. [Binary Search Tree](#binary-search-tree)
...
28. [Advanced Data Structure](#advanced-data-structure)
    - Advanced Lists
...
30. [Matrix](#matrix)
    ...
    - Given an n x n square matrix, find the sum of all sub-squares of size k x k
